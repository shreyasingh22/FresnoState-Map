package com.csu.campusmap.Adapter;
...
/**
 * Created by Ung Man Pak on 2/7/2016.
 */
public class LeftNavAdapter extends BaseAdapter {
    ...
    /** The icons. */
    private int icons[] = {R.mipmap.dininghall, R.mipmap.parking, R.mipmap.food, R.mipmap.gymfinal,
                            R.mipmap.aquatic, R.mipmap.satelite};
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        Typeface Servicingfont = Typeface.createFromAsset(((MenuActivity)context).getResources().getAssets(),"fonts/GOODTIME.ttf");
        lbl.setText(getItem(position));
        lbl.setTypeface(Servicingfont);
